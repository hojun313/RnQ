...
IL_004d:
		...
		{// begin try (depth: 1)
			...
			NullCheck(L_16);
			VirtualActionInvoker1< String_t* >::Invoke(13 /* System.Void System.IO.TextWriter::Write(System.String) */, L_16, L_17);
			StreamWriter_t6E7DF7D524AA3C018A65F62EE80779873ED4D1E4* L_18 = V_2;
			NullCheck(L_18);
			VirtualActionInvoker0::Invoke(9 /* System.Void System.IO.TextWriter::Flush() */, L_18);
			goto IL_004e;
		}// end try (depth: 1)
		catch(Il2CppExceptionWrapper& e)
		{
